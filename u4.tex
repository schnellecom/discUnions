...
\coordinate (V24_1) at (1., -1.732050807568877);
\coordinate (V27_1) at (2., -1.732050807568877);
\coordinate (V32_1) at (0.5000000000000001, -0.8660254037844386);
\coordinate (V33_1) at (0., -1.732050807568877);
\coordinate (V33_2) at (-1.5, -0.866025403784439);
\coordinate (V34_1) at (-1., 0.);
\coordinate (V34_2) at (0.5, -2.598076211353316);
\coordinate (V35_1) at (-0.5, 0.8660254037844384);
\coordinate (V35_2) at (1.5, -2.598076211353316);
\coordinate (V36_1) at (0.4999999999999999, 0.8660254037844386);
\coordinate (V36_2) at (2.5, -0.8660254037844385);
\coordinate (V36_3) at (2.5, -2.598076211353316);
\coordinate (V37_1) at (1., 0.);
\coordinate (V37_2) at (1.5, -0.8660254037844386);


% Fill in the faces
\fill[face=b22222]  (V37_1) -- (V36_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V37_1=1,V36_1=1,V1_1=1) {$1$};
\fill[face=b22222]  (V1_1) -- (V32_1) -- (V37_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V32_1=1,V37_1=1) {$2$};
\fill[face=b22222]  (V1_1) -- (V4_1) -- (V32_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V4_1=1,V32_1=1) {$3$};
\fill[face=b22222]  (V1_1) -- (V34_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V34_1=1,V4_1=1) {$4$};
\fill[face=b22222]  (V1_1) -- (V35_1) -- (V34_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V35_1=1,V34_1=1) {$5$};
\fill[face=b22222]  (V36_1) -- (V35_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V36_1=1,V35_1=1,V1_1=1) {$6$};
\fill[face=b22222]  (V4_1) -- (V33_1) -- (V32_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V33_1=1,V32_1=1) {$7$};
\fill[face=b22222]  (V34_1) -- (V33_2) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V34_1=1,V33_2=1,V4_1=1) {$8$};
\fill[face=049EF4]  (V33_1) -- (V24_1) -- (V32_1) -- cycle;
\node[faceLabel] at (barycentric cs:V33_1=1,V24_1=1,V32_1=1) {$16$};
\fill[face=049EF4]  (V24_1) -- (V37_2) -- (V32_1) -- cycle;
\node[faceLabel] at (barycentric cs:V24_1=1,V37_2=1,V32_1=1) {$17$};
\fill[face=049EF4]  (V24_1) -- (V27_1) -- (V37_2) -- cycle;
\node[faceLabel] at (barycentric cs:V24_1=1,V27_1=1,V37_2=1) {$18$};
...
\fill[face=049EF4]  (V27_1) -- (V36_2) -- (V37_2) -- cycle;
\node[faceLabel] at (barycentric cs:V27_1=1,V36_2=1,V37_2=1) {$22$};
\fill[face=049EF4]  (V35_2) -- (V36_3) -- (V27_1) -- cycle;
\node[faceLabel] at (barycentric cs:V35_2=1,V36_3=1,V27_1=1) {$23$};


% Draw the edges
\draw[edge] (V37_1) -- node[edgeLabel] {$7$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$8$} (V36_1);
\draw[edge] (V32_1) -- node[edgeLabel] {$9$} (V1_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$10$} (V1_1);
\draw[edge] (V32_1) -- node[edgeLabel] {$11$} (V4_1);
\draw[edge] (V34_1) -- node[edgeLabel] {$12$} (V1_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$13$} (V34_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$14$} (V35_1);
\draw[edge] (V33_1) -- node[edgeLabel] {$15$} (V4_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$15$} (V33_2);
\draw[edge] (V32_1) -- node[edgeLabel] {$37$} (V24_1);
\draw[edge] (V24_1) -- node[edgeLabel] {$38$} (V33_1);
\draw[edge] (V37_2) -- node[edgeLabel] {$39$} (V24_1);
\draw[edge] (V27_1) -- node[edgeLabel] {$40$} (V24_1);
\draw[edge] (V37_2) -- node[edgeLabel] {$41$} (V27_1);
...
\draw[edge=32cd32] (V33_2) -- node[edgeLabel] {$47$} (V34_1);
...
\draw[edge=32cd32] (V37_2) -- node[edgeLabel] {$50$} (V36_2);
\draw[edge=32cd32] (V37_1) -- node[edgeLabel] {$51$} (V32_1);
\draw[edge=32cd32] (V32_1) -- node[edgeLabel] {$51$} (V37_2);
