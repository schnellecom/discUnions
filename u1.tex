...
\draw[edge] (V33_1) -- node[edgeLabel] {$46$} (V32_1);
\draw[edge] (V34_1) -- node[edgeLabel] {$47$} (V33_1);
\draw[edge] (V33_1) -- node[edgeLabel] {$47$} (V34_2);
\draw[edge] (V35_1) -- node[edgeLabel] {$48$} (V34_1);
\draw[edge] (V34_2) -- node[edgeLabel] {$48$} (V35_2);
\draw[edge] (V36_2) -- node[edgeLabel] {$49$} (V35_1);
\draw[edge] (V35_2) -- node[edgeLabel] {$49$} (V36_4);
\draw[edge] (V37_1) -- node[edgeLabel] {$50$} (V36_1);
\draw[edge] (V36_3) -- node[edgeLabel] {$50$} (V37_2);
\draw[edge] (V32_1) -- node[edgeLabel] {$51$} (V37_1);
