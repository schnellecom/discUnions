...
\definecolor{049EF4}{HTML}{049EF4}
\definecolor{b22222}{HTML}{b22222}
\definecolor{32cd32}{HTML}{32cd32}
...
\coordinate (V4_1) at (-0.4999999999999998, -0.8660254037844388);
\coordinate (V24_1) at (-1.5, 0.8660254037844384);
\coordinate (V27_1) at (-2.499999999999999, 0.8660254037844382);
\coordinate (V32_1) at (-1., 0.);
\coordinate (V33_1) at (-0.5, 0.8660254037844384);
\coordinate (V34_1) at (0.4999999999999999, 0.8660254037844386);
\coordinate (V34_2) at (-0.9999999999999999, 1.732050807568877);
\coordinate (V35_1) at (1., 0.);
\coordinate (V35_2) at (-2., 1.732050807568876);
\coordinate (V36_1) at (0.5000000000000001, -0.8660254037844386);
\coordinate (V36_2) at (-2.999999999999999, 0.);
\coordinate (V36_3) at (-2.999999999999999, 1.732050807568876);
\coordinate (V37_1) at (0., -1.732050807568877);
\coordinate (V37_2) at (-1.5, -0.866025403784439);
\coordinate (V37_3) at (-2., 0.);


% Fill in the faces
\fill[face=b22222]  (V35_1) -- (V34_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V35_1=1,V34_1=1,V1_1=1) {$1$};
\fill[face=b22222]  (V1_1) -- (V36_1) -- (V35_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V36_1=1,V35_1=1) {$2$};
\fill[face=b22222]  (V1_1) -- (V4_1) -- (V36_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V4_1=1,V36_1=1) {$3$};
\fill[face=b22222]  (V1_1) -- (V32_1) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V32_1=1,V4_1=1) {$4$};
\fill[face=b22222]  (V1_1) -- (V33_1) -- (V32_1) -- cycle;
\node[faceLabel] at (barycentric cs:V1_1=1,V33_1=1,V32_1=1) {$5$};
\fill[face=b22222]  (V34_1) -- (V33_1) -- (V1_1) -- cycle;
\node[faceLabel] at (barycentric cs:V34_1=1,V33_1=1,V1_1=1) {$6$};
\fill[face=b22222]  (V4_1) -- (V37_1) -- (V36_1) -- cycle;
\node[faceLabel] at (barycentric cs:V4_1=1,V37_1=1,V36_1=1) {$7$};
\fill[face=b22222]  (V32_1) -- (V37_2) -- (V4_1) -- cycle;
\node[faceLabel] at (barycentric cs:V32_1=1,V37_2=1,V4_1=1) {$8$};
\fill[face=049EF4]  (V33_1) -- (V24_1) -- (V32_1) -- cycle;
\node[faceLabel] at (barycentric cs:V33_1=1,V24_1=1,V32_1=1) {$16$};
\fill[face=049EF4]  (V24_1) -- (V37_3) -- (V32_1) -- cycle;
\node[faceLabel] at (barycentric cs:V24_1=1,V37_3=1,V32_1=1) {$17$};
\fill[face=049EF4]  (V24_1) -- (V27_1) -- (V37_3) -- cycle;
\node[faceLabel] at (barycentric cs:V24_1=1,V27_1=1,V37_3=1) {$18$};
\fill[face=049EF4]  (V24_1) -- (V35_2) -- (V27_1) -- cycle;
\node[faceLabel] at (barycentric cs:V24_1=1,V35_2=1,V27_1=1) {$19$};
\fill[face=049EF4]  (V24_1) -- (V34_2) -- (V35_2) -- cycle;
\node[faceLabel] at (barycentric cs:V24_1=1,V34_2=1,V35_2=1) {$20$};
\fill[face=049EF4]  (V33_1) -- (V34_2) -- (V24_1) -- cycle;
\node[faceLabel] at (barycentric cs:V33_1=1,V34_2=1,V24_1=1) {$21$};
\fill[face=049EF4]  (V27_1) -- (V36_2) -- (V37_3) -- cycle;
\node[faceLabel] at (barycentric cs:V27_1=1,V36_2=1,V37_3=1) {$22$};
\fill[face=049EF4]  (V35_2) -- (V36_3) -- (V27_1) -- cycle;
\node[faceLabel] at (barycentric cs:V35_2=1,V36_3=1,V27_1=1) {$23$};


% Draw the edges
\draw[edge] (V35_1) -- node[edgeLabel] {$7$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$8$} (V34_1);
\draw[edge] (V36_1) -- node[edgeLabel] {$9$} (V1_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$10$} (V1_1);
\draw[edge] (V36_1) -- node[edgeLabel] {$11$} (V4_1);
\draw[edge] (V32_1) -- node[edgeLabel] {$12$} (V1_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$13$} (V32_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$14$} (V33_1);
\draw[edge] (V37_1) -- node[edgeLabel] {$15$} (V4_1);
\draw[edge] (V4_1) -- node[edgeLabel] {$15$} (V37_2);
\draw[edge] (V32_1) -- node[edgeLabel] {$37$} (V24_1);
\draw[edge] (V24_1) -- node[edgeLabel] {$38$} (V33_1);
\draw[edge] (V37_3) -- node[edgeLabel] {$39$} (V24_1);
\draw[edge] (V27_1) -- node[edgeLabel] {$40$} (V24_1);
\draw[edge] (V37_3) -- node[edgeLabel] {$41$} (V27_1);
\draw[edge] (V35_2) -- node[edgeLabel] {$42$} (V24_1);
\draw[edge] (V27_1) -- node[edgeLabel] {$43$} (V35_2);
\draw[edge] (V24_1) -- node[edgeLabel] {$44$} (V34_2);
\draw[edge] (V36_2) -- node[edgeLabel] {$45$} (V27_1);
\draw[edge] (V27_1) -- node[edgeLabel] {$45$} (V36_3);
\draw[edge=32cd32] (V32_1) -- node[edgeLabel] {$46$} (V33_1);
\draw[edge=32cd32] (V33_1) -- node[edgeLabel] {$47$} (V34_1);
\draw[edge=32cd32] (V34_2) -- node[edgeLabel] {$47$} (V33_1);
\draw[edge=32cd32] (V34_1) -- node[edgeLabel] {$48$} (V35_1);
\draw[edge=32cd32] (V35_2) -- node[edgeLabel] {$48$} (V34_2);
\draw[edge=32cd32] (V35_1) -- node[edgeLabel] {$49$} (V36_1);
\draw[edge=32cd32] (V36_3) -- node[edgeLabel] {$49$} (V35_2);
\draw[edge=32cd32] (V36_1) -- node[edgeLabel] {$50$} (V37_1);
\draw[edge=32cd32] (V37_3) -- node[edgeLabel] {$50$} (V36_2);
\draw[edge=32cd32] (V37_2) -- node[edgeLabel] {$51$} (V32_1);
\draw[edge=32cd32] (V32_1) -- node[edgeLabel] {$51$} (V37_3);


% Draw the vertices
\vertexLabelR{V1_1}{left}{$1$}
\vertexLabelR{V4_1}{left}{$4$}
\vertexLabelR{V24_1}{left}{$24$}
\vertexLabelR{V27_1}{left}{$27$}
\vertexLabelR{V32_1}{left}{$32$}
\vertexLabelR{V33_1}{left}{$33$}
\vertexLabelR{V34_1}{left}{$34$}
\vertexLabelR{V34_2}{left}{$34$}
\vertexLabelR{V35_1}{left}{$35$}
\vertexLabelR{V35_2}{left}{$35$}
\vertexLabelR{V36_1}{left}{$36$}
\vertexLabelR{V36_2}{left}{$36$}
\vertexLabelR{V36_3}{left}{$36$}
\vertexLabelR{V37_1}{left}{$37$}
\vertexLabelR{V37_2}{left}{$37$}
\vertexLabelR{V37_3}{left}{$37$}
